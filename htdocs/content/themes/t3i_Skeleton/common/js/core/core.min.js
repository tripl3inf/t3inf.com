window.onload = function() {
    ...
    var infContainer = infContainer.group(infShape, infShape2).attr({
        fill: "none",
        strokeWidth: 5,
        stroke: "green"
    });
    ...
    var animPath = function(path, time) {
        ...
        function animate() {
            pathTL.to(path.node, 3, {
                opacity: 1
            }, "stage1");
            pathTL.add(TweenLite.to(path.node, time, {
                strokeDashoffset: 0
            }), "stage1");
            pathTL.add(TweenLite.to(path.node, 2, {
                opacity: 0,
                delay: 2
            }));
            pathTL.play();
    ...
    var animLetter = function(path, time, delay) {
        ...
        function animate() {
            ...
            pathTL.add(TweenLite.to(t3iTxt.node, 1.5, {
                opacity: 0,
                delay: 3
            }));
            pathTL.play();
...
function gridOvrlay() {
    ...
    jQuery("#gridBtn").click(function() {
        if (!jQuery(this).is(":checked")) {
            jQuery("#ovrLayContainer").animate({
                opacity: 0
            });
...
(function($) {
    $.fn.animTxtBtn = function() {
        ...
        mainBtn_TL.staggerFromTo(letter, 2, {
            scale: 3,
            rotationX: -180
        }, {
            scale: 1,
    ...
    function bgFade(direction) {
        ...
        if (direction == "in") {
            ...
            TweenLite.to($(".bgOverlay"), 1, {
                autoAlpha: 0,
                onComplete: rmOverlay
            });
        }
    }
    $(document).ready(function() {
        parallax.add(jQuery("#index")).add(jQuery("#portfolio")).add(jQuery("#contact"));
        ...
        $(".navArrow.contact").click(function(event) {
            TweenLite.to($(this), 1, {
                autoAlpha: 0,
                onStart: rtrnHome,
                onComplete: restoreArw
            });
            function rtrnHome() {
                parallax.index.right();
            }
            function restoreArw() {
                TweenLite.set($("#contactArw"), {
                    autoAlpha: 1
                });
            }
            bgFade("out");
...
(function($) {
    var contactSubmt = new TimelineLite({
        paused: true
    });
    contactSubmt.to($("#contactForm"), 1, {
        autoAlpha: 0
    }, "stage1");
    contactSubmt.to($(".navArrow.contact"), 1, {
        autoAlpha: 0,
        onStart: goHome
    }, "stage1");
    function goHome() {
        ...
        TweenLite.set($(".navArrow.contact"), {
            autoAlpha: 1
        });
    }
    $("#submit").click(function(event) {
        $.post("/content/themes/t3i_Skeleton/contact.php", jQuery("#contactForm").serialize(), function(response) {
            ...
            TweenLite.to($("#formSuccessMsg"), .8, {
                autoAlpha: 1,
                delay: .8,
                onComplete: fadeOut
            });
            function fadeOut() {
                TweenLite.to($("#formSuccessMsg"), 1.2, {
                    autoAlpha: 0,
                    delay: 1
                });
            }
...
function animationTL() {
    ...
    a1_TL.add(TweenLite.from(a1_1, .5, {
        alpha: 0,
        ease: Power2.easeIn
    }), 0);
    a1_TL.add(TweenLite.to(a1_1, .5, {
        x: 0,
        y: 0,
        ease: Power1.easeIn
    }), 0);
    a1_TL.add(TweenLite.to(a1_2, .5, {
        x: 0,
        y: 0
    }), .5);
    a1_TL.add(TweenLite.to(a1_3, .5, {
        x: 1,
        y: 0
    }), 1);
    var l1_TL = new TimelineLite();
    l1_TL.add(TweenLite.from(l1, .5, {
        alpha: 0,
        ease: Power2.easeIn
    }), 0);
    l1_TL.add(TweenLite.from(l1, .6, {
        x: -4,
        y: -140,
        ease: Power1.easeIn
    }), 0);
    var e1_TL = new TimelineLite();
    e1_TL.add(TweenLite.from(e1_1, .4, {
        alpha: 0,
        ease: Power2.easeIn
    }), 0);
    e1_TL.add(TweenLite.to(e1_1, .4, {
        x: 0,
        y: 0,
        ease: Power1.easeIn
    }), 0);
    e1_TL.add(TweenLite.to(e1_2, .5, {
        x: 0,
        y: 0
    }), .4);
    e1_TL.add(TweenLite.to(e1_3, .4, {
        x: 0,
        y: 0
    }), .7);
    e1_TL.add(TweenLite.to(e1_4, .4, {
        x: 0,
        y: 0
    }), 1.1);
    var x1_TL = new TimelineLite();
    x1_TL.add(TweenLite.from(x1_2, .5, {
        alpha: 0,
        ease: Power2.easeIn
    }), 0);
    x1_TL.add(TweenLite.to(x1_2, .6, {
        x: 0,
        y: 0,
        ease: Power1.easeIn
    }), 0);
    x1_TL.add(TweenLite.from(x1_1, .5, {
        alpha: 0,
        ease: Power2.easeIn
    }), 0);
    x1_TL.add(TweenLite.to(x1_1, .6, {
        x: 0,
        y: 1,
        ease: Power1.easeIn
    }), .4);
    var a2_TL = new TimelineLite();
    a2_TL.add(TweenLite.from(a2_1, .3, {
        alpha: 0,
        ease: Power2.easeIn
    }), 0);
    a2_TL.add(TweenLite.to(a2_1, .3, {
        x: -1,
        y: 0
    }), 0);
    a2_TL.add(TweenLite.to(a2_2, .5, {
        x: 0,
        y: 0
    }), .3);
    a2_TL.add(TweenLite.to(a2_3, .5, {
        x: 0,
        y: 0
    }), .8);
    a2_TL.add(TweenLite.to(a2_4, .5, {
        x: 2,
        y: 0
    }), 1.5);
    var l2_TL = new TimelineLite();
    l2_TL.add(TweenLite.from(l2, .3, {
        alpha: 0,
        ease: Power2.easeIn
    }));
    l2_TL.insert(TweenLite.to(l2, .5, {
        x: 0,
        y: 0
    }));
    logo_TL.insert(l2_TL);
    var o1_TL = new TimelineLite();
    o1_TL.add(TweenLite.to(o1_1, .4, {
        x: 0,
        y: 0
    }), 0);
    o1_TL.add(TweenLite.to(o1_2, .5, {
        x: 0,
        y: 0
    }), .5);
    o1_TL.add(TweenLite.to(o1_3, .5, {
        x: 0,
        y: 0
    }), 1);
    var i1_TL = new TimelineLite();
    i1_TL.add(TweenLite.from(i1, .3, {
        alpha: 0,
        ease: Power2.easeIn
    }), 0);
    i1_TL.insert(TweenLite.to(i1, .5, {
        x: 0,
        y: 0
    }));
    var a3_TL = new TimelineLite();
    a3_TL.add(TweenLite.from(a3_3, .5, {
        alpha: 0,
        ease: Power2.easeIn
    }), 0);
    a3_TL.add(TweenLite.to(a3_3, .5, {
        x: 0,
        y: 0
    }), 0);
    a3_TL.add(TweenLite.to(a3_2, .5, {
        x: 0,
        y: 1
    }), .5);
    a3_TL.add(TweenLite.to(a3_1, .5, {
        x: 0,
        y: 0
    }), 1);
